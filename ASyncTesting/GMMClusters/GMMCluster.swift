...
actor GMMCluster {
    static let shared = GMMCluster()
    
    public var init_num_of_subclasses: Int     // #_subclasses - initial number of clusters for each class
    public var nclasses: Int                   // <# of classes>
    public var vector_dimension: Int           // <data vector length>
    public var option1: GMMClusterModel        // option1 - (optional) controls clustering model\n");
                                                                //      full - (default) use full convariance matrices\n");
                                                                //      diag - use diagonal convariance matrices\n\n");
    public var option2: Int;                       //    option2 - (optional) controls number of clusters\n");
...
//    convenience init(usingGMMPointsWithInitialSubclasses _init_num_of_subclasses: Int, noClasses: Int, vector_dimension: Int, samples:[[GMMPoint]], option1: GMMClusterModel = .full, option2: Int = 0) {
    init(usingGMMPointsWithInitialSubclasses _init_num_of_subclasses: Int, noClasses: Int, vector_dimension: Int, samples:[[GMMPoint]], option1: GMMClusterModel = .full, option2: Int = 0) async {
        self.init()
...
//    convenience init(usingGMMPointsWithNoClasses noClasses: Int, vector_dimension: Int, samples:[[GMMPoint]], option1: GMMClusterModel = .full, option2: Int = 0) {
    init(usingGMMPointsWithNoClasses noClasses: Int, vector_dimension: Int, samples:[[GMMPoint]], option1: GMMClusterModel = .full, option2: Int = 0) async {
        self.init()
...
//    convenience init(usingClassesFromFile infoFileURL: URL) {
    init(usingClassesFromFile infoFileURL: URL) async {
        self.init()
    ...
    func cluster() -> Void {
        ...
        if var _S = S {
            ...
            for k in 0..<self.nclasses {
                ...
                subcluster.getS()?.classSig[k].copy(sig: &(_S.classSig[k]), nbands:self.vector_dimension)
