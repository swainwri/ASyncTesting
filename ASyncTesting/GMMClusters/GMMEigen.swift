...
//
//  Created by Steve Wainwright on 14/09/2022.
...
actor GMMEigen {
    ...
    //  int n           /*
    static func eigen(M: inout [[Double]], lambda: inout [Double], n: Int) -> Void {
    ...
    static func G_tqli(d: inout [Double], e: inout [Double], n: Int, z: inout [[Double]]) -> Int {
    ...
    static func G_tred2(a: inout [[Double]], n: Int, d: inout [Double], e: inout [Double]) -> Void {
