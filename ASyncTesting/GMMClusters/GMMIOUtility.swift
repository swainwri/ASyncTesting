...
//
//  Created by Steve Wainwright on 18/09/2022.
...
actor GMMIOUtility {
    ...
    static func readFileContents(fileURL: URL) -> (lines: [String]?, error: NSError?) {
...
//                        print("Read the txt ok!")
    ...
    static func writeFile(_ outputString: String, fileURL: URL) -> (status: Bool, error: String) {
        var OK: Bool = false
    ...
    static func trimDownArray(_ items: inout [String]) {
