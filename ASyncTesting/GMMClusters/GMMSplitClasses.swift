...
actor GMMSplitClasses {
    
    public var errorString: String?
    
    private var Sin: SigSet?
    private var Sout: SigSet?
    public func getSout() -> SigSet? { return self.Sout }
    public func setSout(_ Sout: SigSet?) { self.Sout = Sout }
    
    init(inputParameterURL: URL, outputParameterURL: URL) async {
        self.init()
